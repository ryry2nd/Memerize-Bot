...
public class Console extends Thread {
    ...
    private final String help = "help: helps you\nexit: exits\nchlink: changes link\nrefresh: refreshes";
    private final String complaint = "use /help you moron just like literally every other command line in existence. I mean seriously even minecraft has a /help, it's even in the name /help.";
    ...
    public void run() {
        ...
        while (!escape) {
            ...
            else {System.out.println("Unknown command \"" + command + "\" " + complaint);}
        }
    }
}